...
class SuvDetailScreen extends StatefulWidget {
  final SuvCar suv;
  SuvDetailScreen({required this.suv});


  @override
  State<SuvDetailScreen> createState() => _SuvDetailScreenState();
}

class _SuvDetailScreenState extends State<SuvDetailScreen> {
            ...
            children: [
              Container(
                  ...
                  child:Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      Image.asset(widget.suv.image,scale: 7,),
                      Text(widget.suv.title,style:GoogleFonts.roboto(fontWeight:FontWeight.bold,fontSize: 25)),
                      Text('Rs ${widget.suv.price}/day',style:GoogleFonts.roboto(fontWeight:FontWeight.w500,fontSize: 15)),
                            ...
                            child:  Center(
                              child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  ...
                                  Text(
                                    "Vehicle Rental Charge     Rs ${widget.suv.price}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w300),
                                  ),
