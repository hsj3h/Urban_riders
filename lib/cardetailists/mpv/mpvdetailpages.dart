...
class MpvDetailScreen extends StatefulWidget {
  final MpvCar mpvcar;
  MpvDetailScreen({required this.mpvcar});



  @override
  State<MpvDetailScreen> createState() => _MpvDetailScreenState();
}

class _MpvDetailScreenState extends State<MpvDetailScreen> {
            ...
            children: [
              Container(
                  ...
                  child:Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      Image.asset(widget.mpvcar.image,scale: 7,),
                      Text(widget.mpvcar.title,style:GoogleFonts.roboto(fontWeight:FontWeight.bold,fontSize: 25)),
                      Text('Rs ${widget.mpvcar.price}/day',style:GoogleFonts.roboto(fontWeight:FontWeight.w500,fontSize: 15)),
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  child: Container(height: 30,
                                    ...
                                    child: Center(child: Text('Pickup Date',style: GoogleFonts.roboto(fontWeight: FontWeight.bold,fontSize: 15,color: Colors.white),)),),
                            ...
                            child:  Center(
                              child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  ...
                                  Text(
                                    "Vehicle Rental Charge     Rs ${widget.mpvcar.price}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w300),
                                  ),
