...
import 'mpvdetailpages.dart';

class MpvCarModel extends StatelessWidget {
  final MpvCar mpvcar;
  MpvCarModel({required this.mpvcar});
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(height: 3.0),
                                Text('${mpvcar.price}/day',style: GoogleFonts.dmSans(fontSize: 18),),
