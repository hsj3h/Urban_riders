...
import '../sedann/sedancarclass.dart';
class SportsCarDetailScreen extends StatefulWidget {
  final SportsCars spcars;
  SportsCarDetailScreen({required this.spcars});


  @override
  State<SportsCarDetailScreen> createState() => _SportsCarDetailScreenState();
}

class _SportsCarDetailScreenState extends State<SportsCarDetailScreen> {
            ...
            children: [
              Container(
                  ...
                  child:Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      Image.asset(widget.spcars.image,scale: 7,),
                      Text(widget.spcars.title,style:GoogleFonts.roboto(fontWeight:FontWeight.bold,fontSize: 25)),
                      Text('Rs ${widget.spcars.price}/day',style:GoogleFonts.roboto(fontWeight:FontWeight.w500,fontSize: 15)),
                            ...
                            child:  Center(
                              child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  ...
                                  Text(
                                    "Vehicle Rental Charge     Rs ${widget.spcars.price}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w300),
                                  ),
