...
class DetailsScreen extends StatefulWidget {
  final SedanCarModel sedancarmodel;
  DetailsScreen({required this.sedancarmodel});
...
// date Picker
  ...
  Widget build(BuildContext context) {
    var rate=widget.sedancarmodel.price;
            ...
            children: [
              Container(
                  ...
                  child:Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      Image.asset(widget.sedancarmodel.image,scale: 7,),
                      Text(widget.sedancarmodel.title,style:GoogleFonts.roboto(fontWeight:FontWeight.bold,fontSize: 25)),
                      Text('Rs ${widget.sedancarmodel.price}/day',style:GoogleFonts.roboto(fontWeight:FontWeight.w500,fontSize: 15)),
                            ...
                            child:  Center(
                              child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  ...
                                  Text(
                                    "Vehicle Rental Charge     Rs ${widget.sedancarmodel.price}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w300),
                                  ),
