...
class AllcarsDetailscreen extends StatefulWidget {
  final AllCarsclass allcars;
  const AllcarsDetailscreen({super.key, required this.allcars});
  ...
  @override
  State<AllcarsDetailscreen> createState() => _AllcarsDetailscreenState();
}

class _AllcarsDetailscreenState extends State<AllcarsDetailscreen> {
            ...
            children: [
              Container(
                  ...
                  child:Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      Image.asset(widget.allcars.image,scale: 7,),
                      Text(widget.allcars.title,style:GoogleFonts.roboto(fontWeight:FontWeight.bold,fontSize: 25)),
                      Text('Rs ${widget.allcars.price}/day',style:GoogleFonts.roboto(fontWeight:FontWeight.w500,fontSize: 15)),
                            ...
                            child:  Center(
                              child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  ...
                                  Text(
                                    "Vehicle Rental Charge     Rs ${widget.allcars.price}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w300),
                                  ),
